...
<head>
    ...
    <title>Register - JobApply SaaS</title>
...
<body class="h-full flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-slate-400">Join the SaaS Job Apply Portal today</p>
        </div>
        ...
        <div class="backdrop-blur-xl bg-slate-900/60 border border-slate-800 rounded-3xl p-8 shadow-2xl">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-sm font-semibold text-slate-300 mb-1.5">Candidate Full Name</label>
                    <div class="relative">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                            class="block w-full pl-11 pr-4 py-2.5 bg-slate-950/50 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 focus:bg-slate-950 transition-all text-sm"
                ...
                <button type="submit"
                    class="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-950 text-white font-semibold rounded-xl text-sm transition-all mt-4 shadow-lg shadow-emerald-600/25">
                    Register Account
                </button>
            </form>
            ...
            <div class="mt-6 text-center text-sm">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-emerald-400 hover:text-emerald-300 transition-colors ml-1">Sign in instead</a>
            </div>
        </div>
    </div>
